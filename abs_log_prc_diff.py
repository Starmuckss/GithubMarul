...
rename the file: abs_log_prc_diff !!!!!!! problem on outer merge
"""
import pandas as pd
import os
import time
...
input_directory =dir_path + "\\pre_abs_log_prc_difference" # Preprocessed data will be recorded here
...
sampled_dict_of_pairs = np.load(input_directory + "\\sampled_dict_of_pairs.npy",allow_pickle='TRUE').item()
...
for category in category_select:
    ...
    between_df.to_csv(output_directory + "\\" + category + "_between.csv" )  # report as csv ex: deodorant-parfum_between.csv
